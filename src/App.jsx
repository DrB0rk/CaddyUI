...
const localSettings = { userConfigured: true, caddyConfigured: true, configured: true, caddyfilePath: 'Caddyfile', logPaths: ['/var/log/caddy/access.log'], username: 'local', role: 'admin' };
...
export default function App() {
  ...
  const runUpdate = async () => { setUpdating(true); setError(''); try { await api('/api/app/update', { method: 'POST' }); setTimeout(() => { location.reload(); }, 8000); } catch (e) { setError(e.message); setUpdating(false); } };
